...
from chat2 import chat_algorithm_M, load_data_to_dataframe_delete, load_data_to_dataframe
...
def evaluate_initial_population(X, y, population):
    ...
    for individual in population:
        ...
        for train_index, test_index in kfold.split(X_selected):
            ...
            y_pred = chat_algorithm_M(X_test, y_test)  # Aquí se usa el conjunto de prueba X_test, y_test
...
for train_index, test_index in kf.split(X):
    ...
    y_pred = chat_algorithm_M(X_test, y_train)
